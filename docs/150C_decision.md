...
- 25–75 min at 150 °C: **MODELLED / UNKNOWN**. With delayed activator contact and Lee ambient D, several 70–400 μm diameters land in the window in the coupled model. Stokes–Einstein 150 °C scaling makes diffusion **faster** (shorter times). Shell-impeded D can add delay. **Not an experiment.**
...
> PhaseForge-ChemGate removes the intrinsic high-temperature kinetic conflict of the Ru/phosphite branch by using a chemically gated latent catalyst. High-temperature catalyst latency and aqueous-to-organic chemical activation have been demonstrated independently in closely related DCPD systems; the exact 150 °C transformation window remains a model prediction requiring laboratory validation.
